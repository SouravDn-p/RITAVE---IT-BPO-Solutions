...
export const metadata: Metadata = {
  title: "About RITAVE | IT & BPO Solutions Company",
  description:
    "Learn about RITAVE, your trusted partner in IT and BPO solutions. Discover our mission, vision, core values, and leadership team. Serving global clients with excellence.",
  keywords:
    "about RITAVE, IT company, BPO company, healthcare solutions, technology services, leadership team, core values, mission, vision",
};
...
export default function AboutPage() {
  const breadcrumbs = [{ name: "About Us", href: "/about" }];

  return (
    <>
      <Head>
        <link rel="canonical" href="https://ritave.com/about" />
      </Head>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p className="text-lg">
                    ...
                    the global leader in IT and BPO services, recognized for our
                  ...
                  <p>
                    ...
                    meet your current needs but anticipate future challenges.
                    Our team of skilled professionals is dedicated to helping
              ...
              <div className="relative w-full ">
                <Image
                  ...
                  alt="RITAVE professional team collaborating on technology solutions"
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Understanding of international business needs and
                        cultural nuances in serving global clients.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative w-full ">
                <Image
                  ...
                  height={400}
                  src="/mission.png"
                  alt="RITAVE company growth and achievements over the years"
                  className="w-full h-auto rounded-2xl shadow-lg"
                />
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Our core values guide every decision we make and every service
                we deliver.
              </p>
            </div>
